...
class ServerArgs:
    ...
    enable_beam_search: A[
        bool,
        "Enable beam search sampling mode. When enabled, features incompatible "
        "with beam search (PD separation, pipeline parallelism, overlap "
        "schedule, chunked prefill, page_size != 1) are automatically disabled.",
        NS("schedule"),
    ] = False
    ...
    def _handle_beam_search(self):
        ...
        and warn the user, so they do not need to configure these manually.
        """
