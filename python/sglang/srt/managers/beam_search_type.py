...
class BeamSearchOutput:
    """Container for a single request's beam candidates sent across IPC.

    This is a plain dataclass (not a msgspec Struct) because it carries
    ``BeamSearchSequence`` objects with arbitrary Python fields; it is
    transported via the PickleWrapper mechanism in io_struct.
    """

    sequences: List[BeamSearchSequence] = field(default_factory=list)
